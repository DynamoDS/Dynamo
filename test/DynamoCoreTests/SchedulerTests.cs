...
namespace Dynamo.Tests
{
    ...
    public class SchedulerTests
    {
        ...
        {
            var scheduler = new DynamoScheduler(new SampleSchedulerThread(), TaskProcessMode.Immediately);
        ...
        public void TestSchedulerCreationDestruction()
        {
            ...
            var scheduler = new DynamoScheduler(schedulerThread, TaskProcessMode.BySchedule);
