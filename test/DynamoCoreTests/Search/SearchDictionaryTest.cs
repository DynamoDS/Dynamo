...
{
    [TestFixture]
    class EntryDictionaryTest : UnitTestBase
    {
        /// <summary>
        /// This test method will execute several Add methods located in the EntryDictionary class
        ...
        {
            //Arrange
            var EntryDictionary = new EntryDictionary<string>();
            ...
            Assert.Throws<ArgumentException>(() => EntryDictionary.Add("Test", tags, wrongWeights));


            //Check that we have 11 items in the dictionary
            Assert.AreEqual(EntryDictionary.NumTags, 11);
        }
    }   
}
