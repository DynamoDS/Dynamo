...
namespace Dynamo.Tests
{
	class ListTests : DynamoModelTestBase
    {
		...
		public void TestTransposeNormalInput()
		{
			...
			var elements = nodeTranspose.GetValue(0, CurrentDynamoModel.GetCurrentEngineController()).GetElements().ToList();
		...
		public void NumberRange_LacingCrossProduct()
		{
			...
			var actual = numberRange.GetValue(0, CurrentDynamoModel.GetCurrentEngineController()).GetElements().ToList();
		...
		public void AddToList_SimpleTest()
		{
            ...
            var actual = addToList.GetValue(0, CurrentDynamoModel.GetCurrentEngineController()).GetElements().ToList();
		...
		public void SplitList_ComplexAnotherExample()
		{
            ...
            var output = splitList.GetValue(0, CurrentDynamoModel.GetCurrentEngineController()).GetElements().ToList();
		...
		public void TakeFromList_SimpleTest()
		{
            ...
            var firstOutput = takeFromList.GetValue(0, CurrentDynamoModel.GetCurrentEngineController()).GetElements().ToList();
		...
		public void ShiftListIndices_Complex()
		{
            ...
            var output = shiftListIndeces.GetValue(0, CurrentDynamoModel.GetCurrentEngineController()).GetElements().ToList();
		...
		public void GetFromList_AmtAsRangeExpn()
		{
            ...
            var output = getFromList.GetValue(0, CurrentDynamoModel.GetCurrentEngineController()).GetElements().ToList();
		...
		public void DropEveryNth_ComplexTest()
		{
            ...
            var output = takeEveryNth.GetValue(0, CurrentDynamoModel.GetCurrentEngineController()).GetElements().ToList();
			var child = output[0].GetElements().ToList();
			var child1 = output[1].GetElements().ToList();
		...
		public void JoinList_MoreLists()
		{
            ...
            var actual = joinList.GetValue(0, CurrentDynamoModel.GetCurrentEngineController()).GetElements().ToList();
