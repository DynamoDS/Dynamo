...
namespace DynamoCoreWpfTests
{
    public class PreferencesViewModelTests : DynamoViewModelUnitTest
    {
        ...
        public void PathManagerWithDifferentHostTest()
        {
            ...
            string dynamoRevitUserDataDirectory = Path.Combine(revitResolverParams.UserDataRootFolder, "4.0");
            string dynamoRevitCommonDataDirectory = Path.Combine(revitResolverParams.CommonDataRootFolder, "4.0");
