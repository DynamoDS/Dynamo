...
namespace Dynamo.Tests
{
    ...
    class BugTests:DynamoRevitUnitTestBase
    {
        ...
        {
            // Details are available in defect 
            // http://adsk-oss.myjetbrains.com/youtrack/issue/MAGN-4511
        ...
        public void MAGN_2589()
        {
            ...
            string samplePath = Path.Combine(_testPath, @".\Bugs\MAGN_2589.dyn");
            string testPath = Path.GetFullPath(samplePath);
        ...
        public void MAGN_3408()
        {
            ...
            string samplePath = Path.Combine(_testPath, @".\Bugs\MAGN_3408.dyn");
            string testPath = Path.GetFullPath(samplePath);
        ...
        public void SurfaceCreatedUsingCurvesFromRevit()
        {
            ...
            string samplePath = Path.Combine(_testPath, @".\Bugs\SurfaceNew.dyn");
            string testPath = Path.GetFullPath(samplePath);
        ...
        public void MAGN_4566()
        {
            ...
            string samplePath = Path.Combine(_testPath, @".\Bugs\MAGN_4566.dyn");
            string testPath = Path.GetFullPath(samplePath);
