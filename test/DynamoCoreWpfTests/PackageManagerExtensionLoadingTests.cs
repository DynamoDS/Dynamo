    ...
    class PackageManagerExtensionLoadingTests : DynamoTestUIBase
    {
        ...
        public void PackageManagerLoadsAndAddsViewExtension()
        {
            Assert.That(this.View.viewExtensionManager.ViewExtensions.Select(x => x.Name),
                Is.EquivalentTo((new List<string> { "Documentation Browser", "DynamoManipulationExtension","LibraryUI", "Node Auto Complete", "NotificationsExtension", "Workspace References", "Sample View Extension","PackageManagerViewExtension", "Python Migration" })));
        }
