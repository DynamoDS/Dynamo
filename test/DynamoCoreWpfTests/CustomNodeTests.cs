...
namespace DynamoCoreWpfTests
{
    ...
    class CustomNodeTests :  DynamoViewModelUnitTest
    {
        ...
        public void TestDataInputInitializationTest()
        {
            ...
            var supportedDynamoTypesList = DSCore.Data.GetDataNodeDynamoTypeList();
        ...
        [Test]
        public void TestDataInputAutoModeTest()
        {
            var node = new DefineData();
            var integerSlider = new IntegerSlider();
            ViewModel.Model.CurrentWorkspace.AddAndRegisterNode(node, false);
            ViewModel.Model.CurrentWorkspace.AddAndRegisterNode(integerSlider, false);
