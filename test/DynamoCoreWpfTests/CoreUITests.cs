...
namespace DynamoCoreWpfTests
{
    ...
    public class CoreUserInterfaceTests : SystemTestBase
    {
        ...
        public void ShowHideNodeAutoCompleteSearchControl()
        {
            ...
            ViewModel.CurrentSpaceViewModel.ShowNodeAutoCompleteSearchCommand.Execute(ShowHideFlags.Show);
            ...
            ViewModel.CurrentSpaceViewModel.ShowNodeAutoCompleteSearchCommand.Execute(ShowHideFlags.Hide);
