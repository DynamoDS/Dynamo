...
namespace DynamoCoreWpfTests
{
    ...
    public class InfoBubbleTests : DynamoViewModelUnitTest
    {
        ...
        public void CanTriggerDocumentationLinkEvent()
        {
            ...
            InfoBubbleViewModel.InfoBubbleDataPacket infoBubbleDataPacket = new InfoBubbleViewModel.InfoBubbleDataPacket(InfoBubbleViewModel.Style.Error,
        ...
        public void CanAddUserFacingMessagesToNode()
        {
            ...
            ObservableCollection<InfoBubbleViewModel.InfoBubbleDataPacket> nodeMessages = infoBubbleViewModel.NodeMessages;

            // The collections of messages the node displays to the user
            ObservableCollection<InfoBubbleViewModel.InfoBubbleDataPacket> userFacingInfo = infoBubbleViewModel.NodeInfoToDisplay;
            ObservableCollection<InfoBubbleViewModel.InfoBubbleDataPacket> userFacingWarnings = infoBubbleViewModel.NodeWarningsToDisplay;
            ObservableCollection<InfoBubbleViewModel.InfoBubbleDataPacket> userFacingErrors = infoBubbleViewModel.NodeErrorsToDisplay;
            ...
            nodeMessages.Add(new InfoBubbleViewModel.InfoBubbleDataPacket(InfoBubbleViewModel.Style.Info, topLeft, botRight, info1, InfoBubbleViewModel.Direction.Top));
            nodeMessages.Add(new InfoBubbleViewModel.InfoBubbleDataPacket(InfoBubbleViewModel.Style.Warning, topLeft, botRight, warning1, InfoBubbleViewModel.Direction.Top));
            nodeMessages.Add(new InfoBubbleViewModel.InfoBubbleDataPacket(InfoBubbleViewModel.Style.Error, topLeft, botRight, error1, InfoBubbleViewModel.Direction.Top));
        ...
        public void CanDismissUserFacingMessages()
        {
            ...
            // Act
            InfoBubbleViewModel.InfoBubbleDataPacket infoBubbleDataPacket = new InfoBubbleViewModel.InfoBubbleDataPacket(InfoBubbleViewModel.Style.Info, topLeft, botRight, info1, InfoBubbleViewModel.Direction.Top);
        ...
        public void IteratorsDisplayWhenMoreThanOneMessage()
        {
            ...
            InfoBubbleViewModel.InfoBubbleDataPacket infoBubbleDataPacket1 =
                new InfoBubbleViewModel.InfoBubbleDataPacket(InfoBubbleViewModel.Style.Info, topLeft, botRight, info1, InfoBubbleViewModel.Direction.Top);

            nodeMessages.Add(infoBubbleDataPacket1);

            Assert.IsFalse(infoBubbleViewModel.NodeInfoIteratorVisible);

            InfoBubbleViewModel.InfoBubbleDataPacket infoBubbleDataPacket2 =
                new InfoBubbleViewModel.InfoBubbleDataPacket(InfoBubbleViewModel.Style.Info, topLeft, botRight, info2, InfoBubbleViewModel.Direction.Top);
        ...
        {
            var packet = new InfoBubbleViewModel.InfoBubbleDataPacket(
