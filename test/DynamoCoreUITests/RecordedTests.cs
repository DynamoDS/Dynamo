...
namespace DynamoCoreUITests
{
    ...
    public class RecordedTests : DSEvaluationViewModelUnitTest
    {
        ...
        public void TestCustomNode()
        {
            ...
            var workspaces = this.ViewModel.DynamoModel.Workspaces;
        ...
        public void TestCustomNodeUI()
        {
            ...
            {
                var workspaces = ViewModel.DynamoModel.Workspaces;
    ...
    class RecordedTestsDSEngine : RecordedTests
    {
        ...
        public void TestCallsiteMapModifyFunctionParamValue()
        {
            ...
            {
                ProtoCore.Core core = ViewModel.EngineController.LiveRunnerCore;
        ...
        public void Defect_MAGN_2100()
        {
            ...
            NodeModel nodeModel = ViewModel.DynamoModel.CurrentWorkspace.NodeFromWorkspace(
        ...
        public void Defect_MAGN_2563()
        {
            ...
            Assert.AreEqual(1, ViewModel.DynamoModel.CurrentWorkspace.Nodes.Count);
            Assert.AreEqual(0, ViewModel.DynamoModel.CurrentWorkspace.Connectors.Count);


            NodeModel node = ViewModel.DynamoModel.CurrentWorkspace.NodeFromWorkspace
        ...
        public void Defect_MAGN_2290()
        {
            ...
            RunCommandsFromFile("Defect_MAGN_2290.xml", true, (commandTag) =>
            {
                ...
                else if (commandTag == "LastRun")
                {
                    ...
                    NodeModel node1 = ViewModel.DynamoModel.CurrentWorkspace.NodeFromWorkspace
        ...
        public void TestCancelExecution()
        {
            RunCommandsFromFile("TestCancelExecutionFunctionCall.xml", false, (commandTag) =>
            {
                ...
                {
                    AssertNullValues();
                    Assert.AreEqual(false, ViewModel.EngineController.LiveRunnerCore.CancellationPending);
                    Assert.AreEqual(false, ViewModel.Runner.Running);
                }
                else if (commandTag == "AfterRun")
                {
                    Assert.AreEqual(false, ViewModel.EngineController.LiveRunnerCore.CancellationPending);
                    Assert.AreEqual(true, ViewModel.Runner.Running);
                }
