...
b = 2;";
        ...
        public void StepIn_inlineconditional_Imperative_722()
        {
            ...
            Assert.AreEqual(3, vms.ExecutionCursor.StartInclusive.LineNo);
            {
                ExpressionInterpreterRunner watchRunner2 = new ExpressionInterpreterRunner(core, runtimeCore);
            ...
            Assert.AreEqual(4, vms.ExecutionCursor.StartInclusive.LineNo);
            {
                ExpressionInterpreterRunner watchRunner3 = new ExpressionInterpreterRunner(core, runtimeCore);
            ...
            Assert.AreEqual(6, vms.ExecutionCursor.StartInclusive.LineNo);
            {
                ExpressionInterpreterRunner watchRunner4 = new ExpressionInterpreterRunner(core, runtimeCore);
