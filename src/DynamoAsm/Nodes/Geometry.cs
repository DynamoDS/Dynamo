...
namespace Dynamo.Nodes
{
    ...
    [NodeName("Point 2D")]
    [NodeCategory(BuiltinNodeCategories.EXPERIMENTAL_PRIMITIVES)]
    ...
    [DoNotLoadOnPlatforms(Context.REVIT_2013, Context.VASARI_2013)]
    [NodeName("Line - LibG")]
    [NodeCategory(BuiltinNodeCategories.EXPERIMENTAL_CURVE)]
    ...
    [NodeCategory(BuiltinNodeCategories.EXPERIMENTAL_SURFACE)]
    ...
    [NodeCategory(BuiltinNodeCategories.EXPERIMENTAL_SOLID)]
    ...
    [DoNotLoadOnPlatforms(Context.REVIT_2013, Context.VASARI_2013)]
    [NodeName("Translate")]
    [NodeCategory(BuiltinNodeCategories.EXPERIMENTAL_MODIFY)]
    ...
    [DoNotLoadOnPlatforms(Context.REVIT_2013, Context.VASARI_2013)]
    [NodeName("Draw")]
    [NodeCategory(BuiltinNodeCategories.EXPERIMENTAL_VIEW)]
