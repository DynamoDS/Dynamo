...
namespace Dynamo.Nodes
{
    ...
    [NodeName("Point 2D")]
    [NodeCategory(BuiltinNodeCategories.CREATEGEOMETRY_EXPERIMENTAL_PRIMITIVES)]
    ...
    [DoNotLoadOnPlatforms(Context.REVIT_2013, Context.VASARI_2013)]
    [NodeName("Line - LibG")]
    [NodeCategory(BuiltinNodeCategories.CREATEGEOMETRY_EXPERIMENTAL_CURVE)]
    ...
    [NodeCategory(BuiltinNodeCategories.CREATEGEOMETRY_EXPERIMENTAL_SURFACE)]
    ...
    [NodeCategory(BuiltinNodeCategories.CREATEGEOMETRY_EXPERIMENTAL_SOLID)]
    ...
    [DoNotLoadOnPlatforms(Context.REVIT_2013, Context.VASARI_2013)]
    [NodeName("Translate")]
    [NodeCategory(BuiltinNodeCategories.CREATEGEOMETRY_EXPERIMENTAL_MODIFY)]
    ...
    [DoNotLoadOnPlatforms(Context.REVIT_2013, Context.VASARI_2013)]
    [NodeName("Draw")]
    [NodeCategory(BuiltinNodeCategories.CREATEGEOMETRY_EXPERIMENTAL_VIEW)]
