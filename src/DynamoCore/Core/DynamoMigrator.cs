...
namespace Dynamo.Core
{
    ...
    internal class DynamoMigratorBase
    {
        ...
        /// <summary>
        /// Queries the most recent version to migrate to the given current version.
        /// </summary>
        /// <param name="pathManager"></param>
        /// <param name="dynamoLookup"></param>
        ...
        /// <summary>
        /// Query a list of file version objects given a root folder. Assuming the 
        ...
        /// <summary>
        /// Queries list of FileVersion objects, given the IPathManager and 
