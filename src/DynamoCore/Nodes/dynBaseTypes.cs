...
namespace Dynamo.Nodes
{
    ...
    public class NewList : VariableInput
    {
        ...
        public static NodeMigrationData Migrate_0630_to_0700(NodeMigrationData data)
        {
            return MigrateToDsFunction(data, "DSCoreNodes.dll", "List.Create", "List.Create@var[]");
        }
    }
    ...
    public class ListMin : NodeWithOneOutput
    {
        ...
        public static NodeMigrationData Migrate_0630_to_0700(NodeMigrationData data)
        {
            return MigrateToDsFunction(data, "MinimumItemByKey", "MinimumItemByKey@_FunctionObject,var[]");
        }
    ...
    public class ListMax : NodeWithOneOutput
    {
        ...
        public static NodeMigrationData Migrate_0630_to_0700(NodeMigrationData data)
        {
            return MigrateToDsFunction(data, "MaximumItemByKey", "MaximumItemByKey@_FunctionObject,var[]");
        }
    ...
    public class ForEach : BuiltinFunction
    {
        ...
        public static NodeMigrationData Migrate_0630_to_0700(NodeMigrationData data)
        {
            return MigrateToDsFunction(data, "ForEach", "ForEach@_FunctionObject,var[]");
        }
    }
    ...
    public class AndMap : BuiltinFunction
    {
        ...
        public static NodeMigrationData Migrate_0630_to_0700(NodeMigrationData data)
        {
            return MigrateToDsFunction(data, "TrueForAll", "TrueForAll@_FunctionObject,var[]");
        }
    }
    ...
    public class OrMap : BuiltinFunction
    {
        ...
        public static NodeMigrationData Migrate_0630_to_0700(NodeMigrationData data)
        {
            return MigrateToDsFunction(data, "TrueForAny", "TrueForAny@_FunctionObject,var[]");
        }
    }
