...
namespace Dynamo.Nodes
{
    ...
    public static partial class BuiltinNodeCategories
    {
        ...
        public const string VECTORPOINT = "Vector/Point";
            public const string VECTORPOINT_CREATE = "Vector/Point.Create";
            public const string VECTORPOINT_MODIFY = "Vector/Point.Modify";
            public const string VECTORPOINT_QUERY = "Vector/Point.Query";
            public const string VECTORPOINT_GRID = "Vector/Point.Grid";
            public const string VECTORPOINT_TESSELATE = "Vector/Point.Tesselate";

        public const string CURVE = "Curve";
            public const string CURVE_CREATE = "Curve.Create";
            public const string CURVE_INTERSECT = "Curve.Intersect";
            public const string CURVE_DIVIDE = "Curve.Divide";
        ...
        public const string SOLID = "Solid";
            ...
            public const string SOLID_MODIFY = "Solid.Modify";
            public const string SOLID_PRIMITIVES = "Solid.Primitives";
            public const string SOLID_QUERY = "Solid.Extract";
            public const string SOLID_REPAIR = "Solid.Repair";

        public const string SURFACE = "Surface";
            public const string SURFACE_CREATE = "Surface.Create";
            public const string SURFACE_PLANE = "Surface.Plane";
            public const string SURFACE_QUERY = "Surface.Query";
            public const string SURFACE_UV = "Surface.UV";
            public const string SURFACE_INTERSECT = "Surface.Intersect";
            public const string SURFACE_DIVIDE = "Surface.Divide";

        public const string TRANSFORM = "Transform";
            public const string TRANSFORM_APPLY = "Transform.Apply";
            public const string TRANSFORM_MODIFY = "Transform.Modify";
            public const string TRANSFORM_CREATE = "Transform.Create";
