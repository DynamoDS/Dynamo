...
namespace Dynamo.Models
{
    public abstract class WorkspaceModel : NotificationObject, ILocatable, IUndoRedoRecorderClient
    {
        ...
        {
            //dynSettings.Controller.DynamoLogger.Log("Workspace modified.");
            if (OnModified != null)
                OnModified();
        }
        ...
        protected virtual void SerializeSessionData(XmlDocument document)
        {
            ...
            catch (Exception exception)
            {
                ...
                dynSettings.Controller.DynamoLogger.Log(exception.Message);
                dynSettings.Controller.DynamoLogger.Log(exception.StackTrace);
            }
        }
