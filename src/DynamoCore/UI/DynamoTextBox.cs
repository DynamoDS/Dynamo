...
namespace Dynamo.UI.Controls
{
    ...
    public class DynamoPopup : Popup
    {
        ...
        public DynamoPopup()
        {
            ...
            this.MouseEnter+=DynamoPopup_MouseEnter;
            this.MouseLeave+=DynamoPopup_MouseLeave;
        }

        private void DynamoPopup_MouseLeave(object sender, MouseEventArgs e)
        {
        ...
        private void DynamoPopup_MouseEnter(object sender, MouseEventArgs e)
        {
