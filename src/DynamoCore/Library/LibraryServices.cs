...
namespace Dynamo.DSEngine
{
    ...
    internal class LibraryServices
    {
        ...
        private void ImportProcedure(string library, ProcedureNode proc)
        {
            ...
            bool isVisible = proc.MethodAttribute == null || !proc.MethodAttribute.HiddenInLibrary;
            ...
            if (classScope != ProtoCore.DSASM.Constants.kGlobalScope)
            {
                ...
                var classAttributes = classNode.ClassAttributes;
                var isClassHidden = classAttributes != null && classAttributes.HiddenInLibrary;
                if (isVisible)
                {
                    // A procedure is visible if 
                    // 1. The class is visible, or
                    // 2. Its HiddenInLibrary is specified to false
                    isVisible = !isClassHidden || (proc.MethodAttribute != null);
                }
