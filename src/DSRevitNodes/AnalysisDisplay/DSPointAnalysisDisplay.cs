...
namespace DSRevitNodes.AnalysisDisplay
{
    ...
    /// </summary>
    [RegisterForTrace]
    public class DSPointAnalysisDisplay : AbstractAnalysisDisplay
    {
        ...
        private DSPointAnalysisDisplay(Autodesk.Revit.DB.View view, IEnumerable<Autodesk.Revit.DB.XYZ> sampleLocations,
        ...
        /// <param name="samples"></param>
        /// <returns></returns>
        public static DSPointAnalysisDisplay ByViewPointsAndValues(AbstractView view,
                        Autodesk.DesignScript.Geometry.Point[] samplePoints, double[] samples)
        {
            ...
            return new DSPointAnalysisDisplay(view.InternalView, samplePoints.ToXyzs(), samples);
        }
