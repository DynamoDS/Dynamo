...
namespace DSRevitNodes.AnalysisDisplay
{
    ...
    /// </summary>
    [RegisterForTrace]
    public class DSVectorAnalysisDisplay : AbstractAnalysisDisplay
    {
        ...
        private DSVectorAnalysisDisplay(Autodesk.Revit.DB.View view, IEnumerable<Autodesk.Revit.DB.XYZ> sampleLocations,
                        ...
                        Autodesk.DesignScript.Geometry.Point[] samplePoints, Autodesk.DesignScript.Geometry.Vector[] samples)
        {
            ...
            return new DSVectorAnalysisDisplay(view.InternalView, samplePoints.ToXyzs(), samples.ToXyzs());
        }
