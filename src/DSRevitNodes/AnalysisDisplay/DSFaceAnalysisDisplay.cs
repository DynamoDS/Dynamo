...
namespace DSRevitNodes.AnalysisDisplay
{
    ...
    /// </summary>
    [RegisterForTrace]
    public class DSFaceAnalysisDisplay : AbstractAnalysisDisplay
    {
        ...
        private DSFaceAnalysisDisplay(Autodesk.Revit.DB.View view, Reference faceReference, IEnumerable<Autodesk.Revit.DB.UV> sampleLocations,
                        ...
                        double[][] sampleUvPoints, double[] samples)
        {
            ...
            return new DSFaceAnalysisDisplay(view.InternalView, faceReference.InternalReference, sampleUvPoints.ToUvs(), samples);
        }
