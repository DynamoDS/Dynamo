...
namespace DSRevitNodes.Elements
{
    ...
    public class DSElementType : AbstractElement
    {
        ...
        /// </summary>
        internal ElementType InternalElementType
        {
            get;
            private set;
        }
        ...
        /// <returns></returns>
        public static DSElementType ByName(string name)
        {
            if (name == null)
            {
        ...
        private DSElementType(ElementType elementType)
        {
        ...
        /// </summary>
        /// <param name="elementType"></param>
        private void InternalSetElementType(ElementType elementType)
        {
        ...
        /// <returns></returns>
        internal static DSElementType FromExisting(ElementType elementType, bool isRevitOwned)
        {
            return new DSElementType(elementType)
            {
