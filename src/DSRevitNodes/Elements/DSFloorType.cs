...
namespace DSRevitNodes.Elements
{
    ...
    public class DSFloorType : AbstractElement
    {
        ...
        private DSFloorType(Autodesk.Revit.DB.FloorType floorType)
        {
        ...
        /// <returns></returns>
        public static DSFloorType ByName(string name)
        {
            if (name == null)
            {
            ...
            return new DSFloorType(floorType)
            {
                IsRevitOwned = true
            };
        ...
        /// <returns></returns>
        internal static DSFloorType FromExisting(Autodesk.Revit.DB.FloorType floorType, bool isRevitOwned)
        {
            return new DSFloorType(floorType)
            {
