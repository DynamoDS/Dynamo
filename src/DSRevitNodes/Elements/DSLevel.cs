...
namespace DSRevitNodes
{
    ...
    public class DSLevel : AbstractElement
    {
        ...
        private DSLevel(double elevation, string name)
        {
        ...
        /// <param name="name"></param>
        /// <returns></returns>
        public static DSLevel ByElevationAndName(double elevation, string name)
        {
            if (name == null)
            {
            ...
            return new DSLevel(elevation, name);
        }
        ...
        /// <param name="elevation"></param>
        /// <returns></returns>
        public static DSLevel ByElevation(double elevation)
        {
            return new DSLevel(elevation, null);
        }
        ...
        /// <returns></returns>
        public static DSLevel ByLevelAndOffset(DSLevel level, double offset)
        {
            if (level == null)
            {
            ...
            return new DSLevel(level.Elevation + offset, null);
        }
        ...
        /// <param name="name"></param>
        /// <returns></returns>
        public static DSLevel ByLevelOffsetAndName(DSLevel level, double offset, string name)
        {
            if (level == null)
            {
                throw new ArgumentNullException("level");
