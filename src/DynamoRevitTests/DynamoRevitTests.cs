...
namespace DynamoRevitTests
{
    ...
    internal class DynamoRevitTests
    {
        ...
        public void BlendSolid()
        {
            ...
            var result = (Solid)dynSettings.Controller.VisualizationManager.Visualizations[blendNode.GUID.ToString()].First();
        ...
        public void RevolveSolid()
        {
            ...
            //Solid result = nodeAsSolidBase.resultingSolidForTestRun().First();
            var result = (Solid)dynSettings.Controller.VisualizationManager.Visualizations[revolveNode.GUID.ToString()].First();
        ...
        public void SweepToMakeSolid()
        {
            ...
            //Solid result = nodeAsSolidBase.resultingSolidForTestRun().First();
            var result = (Solid)dynSettings.Controller.VisualizationManager.Visualizations[sweepNode.GUID.ToString()].First();
        ...
        public void SolidBySkeleton()
        {
                             ...
                             dynRevitSettings.Revit.Application.VersionName.Contains("Vasari"))
            {
                 ...
                 //Solid result = nodeAsSolidBase.resultingSolidForTestRun().First();
                 var result = (Solid)dynSettings.Controller.VisualizationManager.Visualizations[skeletonNode.GUID.ToString()].First();
        ...
        public void ClosedCurve()
        {
            ...
            //Solid result = nodeAsSolidBase.resultingSolidForTestRun().First();
            var result = (Solid)dynSettings.Controller.VisualizationManager.Visualizations[extrudeNode.GUID.ToString()].First();
