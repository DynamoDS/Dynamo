...
namespace Dynamo.Tests
{
    class SolidTests:DynamoRevitUnitTestBase
    {
        ...
        public void BlendSolid()
        {
            ...
            var result = (Solid)VisualizationManager.GetDrawablesFromNode(blendNode).Keys.First();
        ...
        public void RevolveSolid()
        {
            ...
            var result = (Solid)VisualizationManager.GetDrawablesFromNode(revolveNode).Keys.First();
        ...
        public void SolidBySkeleton()
        {
                             ...
                             dynRevitSettings.Revit.Application.VersionName.Contains("Vasari"))
            {
                ...
                var result = (Solid)VisualizationManager.GetDrawablesFromNode(skeletonNode).Keys.First();
        ...
        public void SweepToMakeSolid()
        {
            ...
            var result = (Solid)VisualizationManager.GetDrawablesFromNode(sweepNode).Keys.First();
