...
namespace Dynamo.Legacy
{
    ...
    public partial class Function
    {
        public void SetupCustomUIElements(object ui)
        {
            ...
            publishCustomNodeItem.Click += (sender, args) =>
            {
                ...
                if (DynamoSettings.Controller.DynamoViewModel.PublishCurrentWorkspaceCommand.CanExecute(null))
                {
                    DynamoSettings.Controller.DynamoViewModel.PublishCurrentWorkspaceCommand.Execute(null);
                } 
            };
    ...
    public partial class Watch
    {
        public void SetupCustomUIElements(dynNodeView nodeUI)
        {
            ...
            DynamoSettings.Controller.PreferenceSettings.PropertyChanged += PreferenceSettings_PropertyChanged;
        }
