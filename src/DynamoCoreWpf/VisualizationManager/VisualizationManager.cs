...
namespace Dynamo
{
    ...
    /// </summary>
    public class VisualizationManager : NotificationObject, IVisualizationManager, IDisposable
    {
        ...
        private void Clear(DynamoModel dynamoModel)
        {
            ...
            // all visualizations.
            Pause(this, EventArgs.Empty);
            OnResultsReadyToVisualize(this, new VisualizationEventArgs(new List<RenderPackage>{}, Guid.Empty, -1));
        }
