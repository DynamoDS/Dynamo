...
namespace Dynamo.ViewModels
{
    ...
    public partial class NodeViewModel : ViewModelBase
    {
        ...
        internal delegate void NodeAutoCompletePopupEventHandler(Window window, PortModel portType);
        ...
        internal void OnRequestAutoCompletePopupPlacementTarget(Window window, PortModel portModel)
        {
            RequestAutoCompletePopupPlacementTarget?.Invoke(window, portModel);
        }
