...
namespace Dynamo.ViewModels
{
    ...
    public partial class NodeViewModel : ViewModelBase
    {
        ...
        internal delegate void NodeAutoCompletePopupEventHandler(Window window, PortType portType, double spacing, double verticalOffset);
        ...
        internal void OnRequestAutoCompletePopupPlacementTarget(Window window, PortType portType, double spacing, double verticalOffset)
        {
            RequestAutoCompletePopupPlacementTarget?.Invoke(window, portType, spacing, verticalOffset);
        }
