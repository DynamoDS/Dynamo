...
namespace Dynamo.ViewModels
{
    ...
    public partial class InfoBubbleViewModel : ViewModelBase
    {
        ...
        public Direction ConnectingDirection
        {
            ...
            set
            {
                connectingDirection = value;
                RaisePropertyChanged("ConnectingDirection");
            }
        }
        ...
        public Uri DocumentationLink
        {
            ...
            set
            {
                ...
                RaisePropertyChanged(nameof(DocumentationLink));
            }
        }
        ...
        public Point TargetTopLeft
        {
            ...
            {
                targetTopLeft = value;
                RaisePropertyChanged("TargetTopLeft");
            }
        }
        ...
        public Point TargetBotRight
        {
            ...
            set
            {
                targetBotRight = value;
                RaisePropertyChanged("TargetBotRight");
            }
        }
        ...
        public Direction LimitedDirection
        {
            ...
            set
            {
                limitedDirection = value;
                RaisePropertyChanged("LimitedDirection");
            }
        }
        ...
        public State InfoBubbleState
        {
            ...
            set
            {
                infoBubbleState = value;
                RaisePropertyChanged("InfoBubbleState");
            }
        }
        ...
        /// </summary>
        public ObservableCollection<InfoBubbleDataPacket> NodeInfoToDisplay { get; } =
        ...
        /// </summary>
        public ObservableCollection<InfoBubbleDataPacket> NodeWarningsToDisplay { get; } =
            new ObservableCollection<InfoBubbleDataPacket>();

        /// <summary>
        /// A collection of formatted, user-visible strings relating to the node's error state
        /// </summary>
        public ObservableCollection<InfoBubbleDataPacket> NodeErrorsToDisplay { get; } =
            new ObservableCollection<InfoBubbleDataPacket>();
        ...
        /// </summary>
        public ObservableCollection<InfoBubbleDataPacket> NodeMessages { get; } =
            new ObservableCollection<InfoBubbleDataPacket>();

        /// <summary>
        /// A collection of messages this node has received that have been manually dismissed by the user.
        /// </summary>
        public ObservableCollection<InfoBubbleDataPacket> DismissedMessages { get; } =
            new ObservableCollection<InfoBubbleDataPacket>();
        ...
        /// </summary>
        internal enum NodeMessageVisibility
        {
            Icon,
            CollapseMessages,
            ShowAllMessages
        ...
        /// <returns></returns>
        private List<InfoBubbleDataPacket> GetMessagesOfStyle(
            ObservableCollection<InfoBubbleDataPacket> infoBubbleDataPackets, Style style)
        {
        ...
        {
            NodeInfoShowLessMessageVisible = NodeInfoShowMoreButtonVisible &&
                                             NodeInfoVisibilityState == NodeMessageVisibility.ShowAllMessages;
            NodeWarningsShowLessMessageVisible = NodeWarningsShowMoreButtonVisible &&
                                                 NodeWarningsVisibilityState == NodeMessageVisibility.ShowAllMessages;
            NodeErrorsShowLessMessageVisible = NodeErrorsShowMoreButtonVisible &&
                                               NodeErrorsVisibilityState == NodeMessageVisibility.ShowAllMessages;
        }
        ...
        private void AutoCollapseSections(int nonDismissedInfoMessageCount, int nonDismissedWarningMessageCount,
            int errorsCount)
        {
            ...
            if (NodeWarningsVisibilityState == NodeMessageVisibility.ShowAllMessages &&
                nonDismissedWarningMessageCount < 2)
            {
        ...
        /// <returns></returns>
        private void SetDisplayMessages(List<InfoBubbleDataPacket> infoBubbleDataPackets,
