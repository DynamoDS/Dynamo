...
{
    public abstract class PackageDependencyItem : NotificationObject
    {
        public abstract ObservableCollection<PackageDependencyItem> Items { get; set; }

        /// <summary>
        ///     If this is a leaf and visible, add to items, otherwise, recurse on children
        /// </summary>
        /// <param name="items">The accumulator</param>
        public void GetVisibleLeaves(ref List<PackageDependencyItem> items)
        {
        ...
        public void AddChild(PackageDependencyElement elem)
        {
            if (elem.Parent != null)
        ...
        {
            private PackageDependencyItem item;

            public ToggleIsExpandedCommand(PackageDependencyItem i)
            {
                this.item = i;
            }
