...
#define __GENERATE_DUMMY_MACROBLOCKS
...
// Dummy macroblocks are generated by looking for lhs variables that start with __aaa to __zzz
// LHS variables that start with this token, is assumed to be the start of a new macroblock
#if __GENERATE_DUMMY_MACROBLOCKS
