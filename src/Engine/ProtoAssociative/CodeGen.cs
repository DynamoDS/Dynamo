            ...
            GraphNode graphNode = null)
        {
            ...
            else if (ProtoCore.CompilerDefinitions.Associative.CompilePass.kClassMemFuncSig == compilePass)
            {
                ...
                foreach (AssociativeNode funcdecl in classDecl.Procedures)
                {
                    ...
                    if (funcDef == null || funcDef.IsStatic || funcDef.IsAutoGenerated)
                        continue;
                    ...
                    if (thisPtrArgName == classsShortName || funcDef.Signature.Arguments.Any(a => a.NameNode.Name == thisPtrArgName))
