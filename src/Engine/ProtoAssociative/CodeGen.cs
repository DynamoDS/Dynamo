    ...
    public class CodeGen : ProtoCore.CodeGen
    {
                                              ...
                                              BinaryExpressionNode bnode)
        {
            ...
            for (int n = 0; n < funcCall.FormalArguments.Count; ++n)
            {
                        ...
                        !isConstructor)
                    {
                        if (null != procCallNode)
                        {
                            if (graphNode.dependentList.Count > 0)
                            {
                                ...
                                {
                                    SymbolNode sym = new SymbolNode();
                                    sym.name = procName.Remove(0, Constants.kSetterPrefix.Length);
                                ...
                                {
                                    var procNodeDummy = new ProcedureNode();
                ...
                else if (ProtoCore.DSASM.Constants.kDotArgIndexPtr == n)
                {
