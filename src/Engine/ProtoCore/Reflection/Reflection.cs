...
namespace ProtoCore
{
    namespace Mirror
    {
        public static class Reflection
        {
            ...
            /// </summary>
            /// <returns></returns>
            public static RuntimeMirror Reflect(string varname, int blockDecl, ProtoCore.Core core, RuntimeCore runtimeCore)
            {
                return new RuntimeMirror(varname, blockDecl, core, runtimeCore);
            }
