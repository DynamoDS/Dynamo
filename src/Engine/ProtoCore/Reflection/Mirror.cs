...
namespace ProtoCore
{
    namespace Mirror
    {
                ...
                else
                {
                    ...
                    switch (sv.optype)
                    {
                        ...
                        case AddressType.FunctionPointer:
                            ...
                            type.Add(/*NXLT*/"function pointer");
                            asmType.Add("", type);
                            break;
                        default:
                            break;
        ...
        public abstract class StaticMirror : MirrorObject
        {
            ...
            {
                if (core == null)
                    throw new ArgumentNullException(/*NXLT*/"core");
        ...
        public class ClassMirror : StaticMirror
        {
                ...
                : base(core, className)
            {
                ...
                if (classNode == null)
                {
                    ...
                    if (ci != ProtoCore.DSASM.Constants.kInvalidIndex)
                    {
                        ...
                        throw new Exception(String.Format(/*NXLT*/"Class {0} not defined", className));
                }
                libraryMirror = new LibraryMirror(classNode.ExternLib, core);
            }
            ...
            public ClassMirror(int classIndex, ProtoCore.Core core)
            {
                ...
                {
                    throw new ArgumentException(/*NXLT*/"classIndex is invalid");
                }
