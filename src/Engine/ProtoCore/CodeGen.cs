            ...
            if (node is ProtoCore.AST.ImperativeAST.IdentifierNode || node is ProtoCore.AST.AssociativeAST.IdentifierNode)
            {
                ...
                else
                {
                    ...
                    if (null == symbolnode)    //unbound identifier
                    {
                        ...
                        {
                            string message = String.Format(ResourceProtoCore.kPropertyIsInaccessible, identnode.Value);
                        ...
                        {
                            string message = String.Format(ResourceProtoCore.kUnboundIdentifierMsg, identnode.Value);
                    ...
                    else
                    {
                        if (callOnClass && !symbolnode.isStatic)
                        {
                            ...
                            {
                                string message = String.Format(ResourceProtoCore.kMethodHasInvalidArguments, procName);
                            ...
                            {
                                string message = String.Format(ResourceProtoCore.kPropertyIsInaccessible, property);
                                buildStatus.LogWarning(ProtoCore.BuildData.WarningID.kCallingNonStaticMethodOnClass, message, core.CurrentDSFileName, identnode.line, identnode.col, graphNode);
                            }
                            else
                            {
