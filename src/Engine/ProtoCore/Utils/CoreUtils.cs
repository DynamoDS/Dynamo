...
namespace ProtoCore.Utils
{
    ...
    private static void InsertPredefinedMethod(Core core, ProtoCore.AST.Node root, bool builtinMethodsLoaded)
    {
        ...
        public static ProcedureNode GetClassAndProcFromGlobalInstance(ProcedureNode procNode, Core core, out int classIndex, List<Type> argTypeList)
        {
            ...
            int functionIndex = core.ClassTable.ClassNodes[classIndex].ProcTable.IndexOfExact(functionName, argTypeList, procNode.isAutoGeneratedThisProc);
            ProtoCore.DSASM.ProcedureNode tmpProcNode = core.ClassTable.ClassNodes[classIndex].ProcTable.procList[functionIndex];
