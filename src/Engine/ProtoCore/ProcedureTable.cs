...
namespace ProtoCore.DSASM
{
    internal class ProcedureMatchOptions
    {
        ...
        internal List<Type> ParameterTypes = null; // Find only functions that match all the parameter types.
        ...
        internal bool ExactMatchWithNumArgs = true; // Must match exact number of arguments.
    }
