...
namespace ProtoCore
{
    public struct StringConstants
    {
        ...
        public const string attributeArgumentMustBeAConstantExpression = "An attribute argument must be a constant expression";
        public const string noConstructorForAttribute = "No constructors for Attribute '{0}' takes {1} arguments";
        public const string modifierBlocksAreNotSupported = "Modifier Blocks are not supported currently.";
        public const string importStatementsAreNotSupported = "Import statements are not supported in CodeBlock Nodes.";
        ...
        public const string identifierExpectedForKeyword = "\"{0}\" is a keyword, identifier expected";
        ...
        public const string usingInlineConditionalInImperativeLanguageBlockInstead = "'{0}' statement can only be used in imperative language block, consider using an inline conditional instead?";
        public const string statementUsedInImpreativeLanguageBlockOnly = "'{0}' statement can only be used in imperative language block.";
