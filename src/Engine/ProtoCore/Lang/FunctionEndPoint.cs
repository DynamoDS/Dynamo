...
namespace ProtoCore
{
	public abstract class FunctionEndPoint
	{
        ...
        public abstract StackValue Execute(ProtoCore.Runtime.Context c, List<StackValue> formalParameters, ProtoCore.DSASM.StackFrame stackFrame, Core core, RuntimeData runtimeCore);
