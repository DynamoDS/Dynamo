...
namespace ProtoCore
{
	...
	public class FunctionGroup
	{
        ...
        /// <summary>
        /// Query a list of all the function end points that are type compliant, there maybe more than one due to pattern matches
        /// </summary>
        /// <returns></returns>
        ...
        /// <summary>
        /// Query a dictionary of the function end points that are type compatible
