...
namespace ProtoCore.Lang
{
    public class BuiltInFunctionEndPoint : FunctionEndPoint
    {
                ...
                case BuiltInMethods.MethodID.kSleep:
                    {
                        ...
                        else
                        {
                            interpreter.runtime.Core.RuntimeStatus.LogWarning(
                                ...
                                StringConstant.kInvalidArguments);
                        }
        ...
        private StackValue DotMethod(StackValue lhs, StackFrame stackFrame, DSASM.Executive runtime, Context context)
        {
            ...
            {
                core.RuntimeStatus.LogWarning(WarningID.kDereferencingNonPointer, StringConstant.kDeferencingNonPointer);
    ...
    internal class FileIOBuiltIns
    {
        ...
        internal static StackValue LoadCSVWithMode(StackValue fn, StackValue trans, ProtoCore.DSASM.Interpreter runtime)
        {
            ...
            {
                // Type mismatch.
                runtime.runtime.Core.RuntimeStatus.LogWarning(RuntimeData.WarningID.kInvalidArguments, ProtoCore.StringConstant.kInvalidArguments);
            ...
            {
                string message = String.Format(ProtoCore.StringConstant.kFileNotFound, path);
                                                   ...
                                                   ProtoCore.Core core)
        {
            if (!svStart.IsNumeric || !svEnd.IsNumeric)
            {
                core.RuntimeStatus.LogWarning(
                    ...
                    StringConstant.kInvalidArgumentsInRangeExpression);
                return StackValue.Null;
            }
            ...
            if (hasAmountOp)
            {
                if (!svEnd.IsNumeric)
                {
                    core.RuntimeStatus.LogWarning(
                        WarningID.kInvalidArguments, 
                        StringConstant.kInvalidAmountInRangeExpression);
                    return StackValue.Null;
                }
                else if (!hasStep)
                {
                    core.RuntimeStatus.LogWarning(
                        WarningID.kInvalidArguments, 
                        StringConstant.kNoStepSizeInAmountRangeExpression);
                    return StackValue.Null;
                }
            }
    ...
    internal class ArrayUtilsForBuiltIns
    {
        ...
        internal static bool Exists(StackValue sv, ProtoCore.DSASM.Interpreter runtime, Predicate<StackValue> pred)
        {
            ...
            {
                // Type mismatch.
                runtime.runtime.Core.RuntimeStatus.LogWarning(RuntimeData.WarningID.kInvalidArguments, StringConstant.kInvalidArguments);
                return false;
            }
        ...
        internal static StackValue Remove(StackValue sv1, StackValue sv2, ProtoCore.DSASM.Interpreter runtime)
        {
            ...
            {
                // Type mismatch.
                runtime.runtime.Core.RuntimeStatus.LogWarning(RuntimeData.WarningID.kIndexOutOfRange, StringConstant.kIndexOutOfRange);
                return DSASM.StackValue.Null;
            }
            List<StackValue> svList = new List<StackValue>();
