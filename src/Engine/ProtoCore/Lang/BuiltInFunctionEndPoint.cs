...
namespace ProtoCore.Lang
{
    public class BuiltInFunctionEndPoint : FunctionEndPoint
    {
                ...
                case BuiltInMethods.MethodID.kSleep:
                    {
                        ...
                        else
                        {
                            interpreter.runtime.Core.RuntimeStatus.LogWarning(
                                ...
                                ResourceProtoCore.kInvalidArguments);
                        }
        ...
        private StackValue DotMethod(StackValue lhs, StackFrame stackFrame, DSASM.Executive runtime, Context context)
        {
            ...
            {
                core.RuntimeStatus.LogWarning(WarningID.kDereferencingNonPointer, ResourceProtoCore.kDeferencingNonPointer);
    ...
    internal class FileIOBuiltIns
    {
        ...
        internal static StackValue LoadCSVWithMode(StackValue fn, StackValue trans, ProtoCore.DSASM.Interpreter runtime)
        {
            ...
            {
                // Type mismatch.
                runtime.runtime.Core.RuntimeStatus.LogWarning(RuntimeData.WarningID.kInvalidArguments, ProtoCore.ResourceProtoCore.kInvalidArguments);
            ...
            {
                string message = String.Format(ResourceProtoCore.kFileNotFound, path);
                                                   ...
                                                   ProtoCore.Core core)
        {
            if (!svStart.IsNumeric || !svEnd.IsNumeric)
            {
                core.RuntimeStatus.LogWarning(
                    ...
                    ResourceProtoCore.kInvalidArgumentsInRangeExpression);
                return StackValue.Null;
            }
            ...
            if (hasAmountOp)
            {
                if (!svEnd.IsNumeric)
                {
                    core.RuntimeStatus.LogWarning(
                        WarningID.kInvalidArguments, 
                        ResourceProtoCore.kInvalidAmountInRangeExpression);
                    return StackValue.Null;
                }
                else if (!hasStep)
                {
                    core.RuntimeStatus.LogWarning(
                        WarningID.kInvalidArguments, 
                        ResourceProtoCore.kNoStepSizeInAmountRangeExpression);
                    return StackValue.Null;
                }
            }
    ...
    internal class ArrayUtilsForBuiltIns
    {
        ...
        internal static bool Exists(StackValue sv, ProtoCore.DSASM.Interpreter runtime, Predicate<StackValue> pred)
        {
            ...
            {
                // Type mismatch.
                runtime.runtime.Core.RuntimeStatus.LogWarning(RuntimeData.WarningID.kInvalidArguments, ResourceProtoCore.kInvalidArguments);
                return false;
            }
        ...
        internal static StackValue Remove(StackValue sv1, StackValue sv2, ProtoCore.DSASM.Interpreter runtime)
        {
            ...
            {
                // Type mismatch.
                runtime.runtime.Core.RuntimeStatus.LogWarning(RuntimeData.WarningID.kIndexOutOfRange, ResourceProtoCore.kIndexOutOfRange);
                return DSASM.StackValue.Null;
            }
            List<StackValue> svList = new List<StackValue>();
