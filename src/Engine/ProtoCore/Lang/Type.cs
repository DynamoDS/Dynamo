    ...
    public class TypeSystem
    {
        ...
        public static StackValue Coerce(StackValue sv, Type targetType, Core core)
        {
            ...
            if (!(
                ...
                || sv.IsArray))
            {
                core.RuntimeStatus.LogWarning(RuntimeData.WarningID.kConversionNotPossible, ProtoCore.Resource.kConvertNonConvertibleTypes);
            ...
            if (sv.IsArray && !targetType.IsIndexable)
            {
                ...
                string errorMessage = String.Format(ProtoCore.Resource.kConvertArrayToNonArray, core.TypeSystem.GetType(targetType.UID));
            ...
            switch (targetType.UID)
            {
                ...
                case (int)PrimitiveType.kTypeFunctionPointer:
                    ...
                    {
                        core.RuntimeStatus.LogWarning(RuntimeData.WarningID.kTypeMismatch, ProtoCore.Resource.kFailToConverToFunction);
                        return StackValue.Null;
                    }
                    return sv;
                ...
                case (int)PrimitiveType.kTypeInt:
                    {
                        if (sv.metaData.type == (int)PrimitiveType.kTypeDouble)
                        {
                            ...
                            //core.RuntimeStatus.LogWarning(RuntimeData.WarningID.kTypeConvertionCauseInfoLoss, ProtoCore.Resource.kConvertDoubleToInt);
                        }
                        return sv.ToInteger();
                    }
                ...
                case (int)PrimitiveType.kTypeNull:
                    {
                        ...
                        {
                            core.RuntimeStatus.LogWarning(RuntimeData.WarningID.kTypeMismatch, ProtoCore.Resource.kFailToConverToNull);
                            return StackValue.Null;
                        }
                        return sv;
                    }
                ...
                case (int)PrimitiveType.kTypePointer:
                    {
                        if (sv.metaData.type != (int)PrimitiveType.kTypeNull)
                        {
                            core.RuntimeStatus.LogWarning(RuntimeData.WarningID.kTypeMismatch, ProtoCore.Resource.kFailToConverToPointer);
                            return StackValue.Null;
                        }
                        return sv;
                    }
