...
public class Scanner {
	...
	static Scanner() {
		...
		for (int i = 48; i <= 57; ++i) start[i] = 32;
		start[34] = 7; 
		start[39] = 9; 
		start[46] = 33; 
		start[64] = 34; 
	...
	Token NextToken() {
		...
		switch (state) {
			...
			case 29:
				...
				if (ch <= 9 || ch >= 11 && ch <= 65535) {AddCh(); goto case 29;}
			...
			case 40:
				if (ch <= ')' || ch >= '+' && ch <= '.' || ch >= '0' && ch <= 65535) {AddCh(); goto case 30;}
