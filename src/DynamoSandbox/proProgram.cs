...
namespace DynamoStudio
{
    ...
    class Program
    {
        ...
        static void Main(string[] args)
        {
            ...
            setup.RunApplication(new DynamoProApp(splashWindow));
        }
        ...
        private static string GetDynamoCorePath()
        {
            ...
            var dynamoStudioRootDirectory = Path.GetDirectoryName(assembly.Location);
            var dynamoRoot = GetDynamoRoot(dynamoStudioRootDirectory);

            var installs = DynamoInstallDetective.DynamoProducts.FindDynamoInstallations(dynamoRoot);
        ...
        /// <returns></returns>
        private static string GetDynamoRoot(string dynamoStudioRootDirectory)
        {
            ...
            return dynamoStudioRootDirectory.Replace("DynamoPro", "Dynamo");
        }
