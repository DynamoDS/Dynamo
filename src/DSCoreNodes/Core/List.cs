...
namespace DSCoreNodes.Core
{
    ...
    public class List
    {
        ...
        public static IList AddToFront(object o, IList list)
        {
        ...
        /// </param>
        public static IList<T> Take<T>(IList<T> list, int amount)
        {
        ...
        /// </param>
        public static IList<T> Drop<T>(IList<T> list, int amount)
        {
        ...
        /// </param>
        public static IEnumerable<T> ShiftIndices<T>(IList<T> list, int amount)
        {
        ...
        public static object GetFromIndex(IList list, int index)
        {
            return list[index];
        }
        ...
        public static IList<T> RemoveAtIndex<T>(IList<T> list, int index)
        {
        ...
        public static IList<T> RemoveAtIndex<T>(IList<T> list, IEnumerable<int> indices)
        {
        ...
        public static IList Empty
        {
            get
            {
                return new ArrayList(); //TODO: can we safely memo-ize?
            }
        }
        ...
        public static IList Partition(IList list, int subLength)
        {
