...
{
    /// <summary>
    ///     Custom Color UI node.
    /// </summary>
    [NodeName("Color Picker")]
    [NodeDescription("ColorPaletteDescription", typeof(Resources))]
    [NodeCategory("Core.Color.Create")]
    [NodeSearchTags("ColorPaletteSearchTags", typeof(Resources))]
    [IsDesignScriptCompatible]
    [OutPortNames("Color")]
    [OutPortTypes("Color")]
    [OutPortDescriptions("Selected Color.")]
    public class nColorPicker : NodeModel, INotifyPropertyChanged
    {
    ...
    ///     View customization.
    /// </summary>
    public class ColorPickerNodeViewCustomization : INodeViewCustomization<nColorPicker>
    {
        /// <summary>
        ///     WPF Control.
        /// </summary>
        public Colorpickui ColorpickuiC;
        ...
        public void CustomizeView(nColorPicker model, NodeView nodeView)
        {
            ColorpickuiC = new Colorpickui();
