...
{
    public class GaussianCurve_old : CurveBase_old
    {
        ...
        /// </summary>
        public GaussianCurve_old(double cp1X, double cp1Y, double cp2X, double cp2Y, double cp3X, double cp3Y, double cp4X, double cp4Y, double canvasSize)
            : base(canvasSize)
        {
            ControlPoint1X = cp1X;
            ControlPoint1Y = cp1Y;
