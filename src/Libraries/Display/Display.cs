...
namespace Display
{
    public class Display :  IGraphicItem
    {
        ...
        public static Display ByGeometryColor([TransferOwnership]Geometry geometry, Color color)
        {
            if (geometry == null)
            {
        ...
        /// <returns>A Display object.</returns>
        public static Display BySurfaceColors([TransferOwnership]Surface surface,
        ...
        public static Display ByPointsColors([TransferOwnership]Point[] points, Color[] colors)
        {
            if(points == null)
            {
