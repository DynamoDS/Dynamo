...
namespace DSCore
{
    ...
    public static class List
    {
        ...
        /// <summary>
        /// Queries an item from the given list that's located at the specified index.
        /// </summary>
        ...
        /// <summary>
        ///     Queries a single sub-list from the given list, based on starting index, ending index,
        ///     and a step amount.
        /// </summary>
        ...
        /// <summary>
        ///     Queries the number of items stored in the given list.
        /// </summary>
        ...
        /// <summary>
        ///     Queries the first item in a list.
        /// </summary>
