...
namespace DSCore
{
    ...
    public static class List
    {
        ...
        /// <summary>
        ///     Returns the index of the element in the given list. Match between given list and target element must be a hard match (i.e. int to int, double to double, string to string, object to object etc.)
        /// </summary>
        /// <param name="list">The list to find the element in.</param>
        /// <param name="element">The element whose index is to be returned.</param>
        /// <returns name="int">The index of the element in the list. Invalid index -1 will be returned if hard match not found.</returns>
