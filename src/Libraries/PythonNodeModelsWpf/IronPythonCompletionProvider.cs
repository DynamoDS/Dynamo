...
namespace Dynamo.Python
{
    ...
    public class IronPythonCompletionProvider : LogSourceBase
    {
        ...
        /// <summary>
        ///     Query a type from a name.  For example: System.Collections or System.Collections.ArrayList
        /// </summary>
        ...
        /// <summary>
        /// Query the name from the end of a string.  Matches back to the first space and trims off spaces or ('s
