...
namespace Unfold
{
    public static class GraphUtilities
    {
        ...
        public static List<UnfoldPlanar.graph_vertex<T>> CloneGraph<T>(List<UnfoldPlanar.graph_vertex<T>> graph )
        {
            ///this is really a clone method in next 3 for loops
            //create new verts and store them in a new list
            List<UnfoldPlanar.graph_vertex<T>> graph_to_traverse = new List<UnfoldPlanar.graph_vertex>();
