...
namespace Dynamo.Nodes
{
    public class Python : MigrationNode
    {
        ...
        public static NodeMigrationData Migrate_0630_to_0700(NodeMigrationData data)
        {
            ...
            var element = MigrationManager.CloneAndChangeName(xmlNode, "DSCoreNodesUI.PythonNode", "Python Script");
    ...
    public class PythonString : MigrationNode
    {
        ...
        {
            System.Xml.XmlElement xmlNode = data.MigratedNodes.ElementAt(0);
            var element = MigrationManager.CloneAndChangeName(xmlNode, "DSCoreNodesUI.PythonStringNode", "Python Script From String");
...
namespace DSIronPythonNode
{
    public class PythonNode : MigrationNode
    {
        ...
        {
            System.Xml.XmlElement xmlNode = data.MigratedNodes.ElementAt(0);
            var element = MigrationManager.CloneAndChangeName(xmlNode, "DSCoreNodesUI.PythonNode", "Python Script", true);
