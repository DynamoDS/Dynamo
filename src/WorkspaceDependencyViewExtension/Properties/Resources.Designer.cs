...
namespace Dynamo.WorkspaceDependency.Properties {
    ...
    public class Resources {
        ...
        /// <summary>
        ///   Looks up a localized string similar to Some Python nodes in this graph use {0} engine from package {1} version {2}, but version {3} is currently installed. This version mismatch may cause warnings or errors when running the graph.
        ///Update the Python nodes to use the current package version?.
        /// </summary>
        public static string PythonPackageVersionMismatchDialogMessage {
            get {
                return ResourceManager.GetString("PythonPackageVersionMismatchDialogMessage", resourceCulture);
            }
        }
        
        /// <summary>
        ///   Looks up a localized string similar to Update Python nodes to newer engine?.
        /// </summary>
        public static string PythonPackageVersionMismatchDialogTitle {
            get {
                return ResourceManager.GetString("PythonPackageVersionMismatchDialogTitle", resourceCulture);
            }
        }
