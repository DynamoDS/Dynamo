...
In cases where the T-Spline becomes invalid, its preview automatically switches to box mode. The node `TSplineSurface.IsInBoxMode` is another way to identify if the surface becomes invalid. 
