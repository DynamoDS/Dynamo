## Подробности
Этот узел преобразует объект в строку. Второй входной параметр, `format specifier`, управляет преобразованием числовых входных данных в их строковые представления.
