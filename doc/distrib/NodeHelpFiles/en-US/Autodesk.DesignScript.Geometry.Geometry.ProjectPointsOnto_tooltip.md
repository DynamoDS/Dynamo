...
Projects a collection of points onto this geometry along a given direction. Returns a flat array of resulting geometry.
...
- Clear and concise (two sentences)
- Period at end (two-sentence rule)
