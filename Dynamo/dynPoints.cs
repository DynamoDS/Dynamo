...
namespace Dynamo.Nodes
{
    ...
    public class dynReferencePointByXYZ : dynRevitNode
    {
        ...
        private PortData outPortData = new PortData("pt", "The Reference Point(s) created from this operation.", typeof(ReferencePoint));
    ...
    public class dynDistanceBetweenPoints : dynNode
    {
        ...
        private PortData outPortData = new PortData("dist", "Distance between points.", typeof(double));
        public override PortData OutPortData
        {
            get { return outPortData; }
        }
    ...
    public class dynPointOnEdge : dynRevitNode
    {
        ...
        private PortData outPortData = new PortData("pt", "PointOnEdge", typeof(ReferencePoint));
        public override PortData OutPortData
        {
            get { return outPortData; }
        }
    ...
    public class dynPointOnFace : dynRevitNode
    {
        ...
        private PortData outPortData = new PortData("pt", "PointOnFace", typeof(ReferencePoint));
        public override PortData OutPortData
        {
            get { return outPortData; }
        }
    ...
    public class dynPointNormalDistance : dynRevitNode
    {
      ...
      private PortData outPortData = new PortData("pt", "Point", typeof(ReferencePoint));
      public override PortData OutPortData
      {
          get { return outPortData; }
      }
