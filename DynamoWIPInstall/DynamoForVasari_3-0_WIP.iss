...
DefaultGroupName=
OutputDir=.
OutputBaseFilename=Vasari_Beta1-0_WIP_Dynamo_Add-In
...
Source: HelixToolkit.Wpf.Input.dll; DestDir: {app}; Flags: ignoreversion overwritereadonly; Components: DynamoForVasariWIP
