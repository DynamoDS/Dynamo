...
[Setup]
AppName=Revit 2012 WIP Dynamo Add-In
AppVerName=Dynamo For Revit 2012 
...
VersionInfoCompany=
VersionInfoDescription==Revit 2012 WIP Dynamo Add-In
VersionInfoTextVersion==Revit 2012 WIP Dynamo Add-In
VersionInfoCopyright=
DefaultDirName=C:\VasariWIP\Revit_2012\Dynamo  
DefaultGroupName=
OutputDir=.
OutputBaseFilename=Revit_2012_WIP_Dynamo_Add-In
...
UninstallDisplayName=Revit 2012 WIP Dynamo Add-In
...
[UninstallDelete]
Type: files; Name: "{userappdata}\Autodesk\Revit\Addins\2012\DynamoforRevit_2012_WIP.addin"
...
begin
  ...
  begin
	...
	AddInFilePath := ExpandConstant('{userappdata}\Autodesk\Revit\Addins\2012\DynamoforRevit_2012_WIP.addin');
