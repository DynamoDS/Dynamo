...
[Setup]
AppName=Vasari 2.5 WIP Dynamo Add-In
AppVerName=Dynamo For Vasari .10
...
VersionInfoCompany=
VersionInfoDescription==Vasari 2.5 WIP Dynamo Add-In
VersionInfoTextVersion==Vasari 2.5 WIP Dynamo Add-In
VersionInfoCopyright=
DefaultDirName=C:\VasariWIP\2-5\Dynamo
DefaultGroupName=
OutputDir=.
OutputBaseFilename=Vasari_2-5_WIP_Dynamo_Add-In
...
begin
  ...
  begin
	...
	AddInFilePath := ExpandConstant('{userappdata}\Autodesk\Vasari\Addins\TP2.5\DynamoforVasari_2.5_WIP.addin');
