RMDIR "..\DynamoRevit\bin\Debug\definitions" /S /Q
RMDIR "..\DynamoRevit\bin\Debug\Samples" /S /I /Y /R
xcopy "..\definitions\*.*" "..\DynamoRevit\bin\Debug\definitions" /S /I /Y /R
xcopy "..\Samples\*.*" "C:\xfer\dev\dynamo_VasBeta1_2013f\DynamoRevit\bin\Debug\Samples" /S /I /Y /R
