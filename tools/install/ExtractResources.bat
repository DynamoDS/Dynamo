...
robocopy "%player%\DynamoPlayer-Revit2017.1.0.0\Revit_2017" "%binroot%\Revit_2017" /e
robocopy "%player%\DynamoPlayer-SampleScripts-Revit.1.0.0\Revit" "%binroot%\samples\en-US\DynamoPlayer" /e
