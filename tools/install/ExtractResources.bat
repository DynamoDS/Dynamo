...
IF EXIST "%binroot%\Revit_2019" (
robocopy "%binroot%\Revit_2019"               "%wwlroot%\Revit_2019"                *.dll *.exe -XF *tests.dll *.customization.dll 
robocopy "%binroot%\Revit_2019\en-US"         "%wwlroot%\Revit_2019\en-US"          *.resources.dll *.xml
robocopy "%binroot%\Revit_2019\nodes"         "%wwlroot%\Revit_2019\nodes"          *.dll
robocopy "%binroot%\Revit_2019\nodes\en-US"   "%wwlroot%\Revit_2019\nodes\en-US"    *.resources.dll *.xml
)
