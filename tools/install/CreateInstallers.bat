...
rem robocopy %cwd%\..\..\extern\Installer\3rdParty %cwd%\temp\3rdParty\OpenSourceComponents /s /nfl /ndl /njh /njs /nc /ns /np
rem if %ERRORLEVEL% equ 1 ( set errorlevel=0 ) else if %ERRORLEVEL% equ 3 ( set errorlevel=0)
